...
if(argument0=true){
		var newcarn = instance_create_layer(gridcoords[0],gridcoords[1], "Instances", oCarn);
		...
		var newherb = instance_create_layer(gridcoords[0],gridcoords[1], "Instances", oCarn);
